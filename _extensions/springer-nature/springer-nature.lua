-- cite style constants UPDATED TO SN
local kBibStyleDefault = 'basic'
local kBibStyles = {'apacite','aps','basic','chicago','mathphys','standardnature','vancouver'}
local kBibStyleApacite = 'sn-apacite'
local kBibStyleAPS = 'sn-aps'
local kBibStyleBasic = 'sn-basic'
local kBibStyleChicago = 'sn-chicago'
local kBibStyleMathPhys = 'sn-mathphys'
local kBibStyleStandardNature = 'sn-standardnature'
local kBibStyleVancouver = 'sn-vancouver'
local kBibStyleUnknown = kBibStyleBasic

-- layout and style STILL ORIGINAL ELSEVIER FROM THIS POINT ON
